        ...
        {accessibleDepartments.map((dept) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              {/* Department Name */}
              <h2 className="text-2xl font-bold text-slate-800 mb-2">{dept.name}</h2>
              ...
              {/* Staff Count */}
              <div
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${dept.color} text-white font-semibold`}
              >
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-3xl font-bold text-orange-600">
                {kitchenCount + fohCount + stewardingCount}
              </p>
